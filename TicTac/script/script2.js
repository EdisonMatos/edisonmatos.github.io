...
//         if (this.innerText === "-") {
//             if (turn === playerX) {
//                 socket.emit('click', { square: element.target.id });
//                 this.innerText = "X";
...
//         draw = true;
//     }
//     isEmitter ? socket.emit('newTurn', 'New turn emmited') : null
// }
...
//         drawCount = 0;
//         draws.innerText = "Empates: " + drawCount;
//         isEmitter ? socket.emit('resetPoints', 'Reset emmited') : null
//         newTurn();
//     } else {
//         alert("Reset cancelado.");
//     }
...
//     square9.removeEventListener('click', clickOnSquare);
// }
// function checkSquareVictory(square) {
//     square.classList.replace('squares', 'squaresVictory');
//     square.classList.replace('squares', 'squaresVictory');
//     square.classList.replace('squares', 'squaresVictory');
// }
...
//         [square1, square2, square3].forEach((square) => checkSquareVictory(square))
//         addScorePoint();
//         draw = false;
...
//         [square4, square5, square6].forEach((square) => checkSquareVictory(square))
//         addScorePoint();
//         draw = false;
